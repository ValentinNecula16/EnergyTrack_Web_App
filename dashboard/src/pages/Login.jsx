        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          >
            <label className="flex items-center cursor-pointer hover:text-white transition-colors">
              <input
                type="checkbox"
                className="mr-2 rounded border-gray-600 focus:ring-0"
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full text-black font-bold py-4 px-6 rounded-xl shadow-lg transform transition-all duration-200 hover:scale-[1.02] active:scale-95 flex justify-center items-center gap-2 ${loading ? "opacity-70 cursor-wait" : ""}`}
            style={{
